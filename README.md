...
**Methods**  
This project combines data cleaning, abstraction, and visualization to analyze the structure of the semiconductor industry. Interactive charts are used to support comparison across countries, companies, and time periods. The visualizations include pie charts, bar charts, stacked bar charts, line charts, and scatter plots. Interactive features include filtering, highlighting, and coordinated views across multiple charts.

**Data Sources**  
USGS, CC0 1.0, update frequency not specified  
USGS Mineral Commodity Summaries 2025, CC0 1.0, annual  
Global Trade Alert, CC BY 4.0, continuous  
Emerging Technology Observatory, CC BY-NC 4.0, annual  
FRED Producer Price Index, public domain, monthly  
OECD ANBERD database, CC BY 4.0, updated November 28, 2024  
EU Industrial R&D Investment Scoreboard, CC BY 4.0, annual  

**Tech Stack**  
Python (Pandas), Altair, HTML, CSS, JavaScript
